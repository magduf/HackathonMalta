...
uint tokenID, uint8 questionNumber, string guess

async function submitGuess(contract, tokenID, questionNumber, guess) {
  const params = new MapEntry()
  await contract.callAsync('submitGuess', params)
}
